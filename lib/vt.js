...
function VTable(props, ref) {
  ...
  }, [ctx.scroll.y]); // expose to the parent components you are using.
  ...
  }, /*#__PURE__*/_react.default.createElement(Table, Object.assign({}, rest, {
    style: rest_style
  }))));
}
...
function VWrapper(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(Wrapper, Object.assign({}, restProps), measureRow, trs);
}
...
function VTRow(props) {
  ...
  if (!Array.isArray(children)) {
    ...
    return /*#__PURE__*/_react.default.createElement(Row, Object.assign({}, rest), children);
  }

  var index = children[0].props.index;
  var last_index = (0, _react.useRef)(children[0].props.index);
  (0, _react.useEffect)(function () {
  ...
  (0, _react.useEffect)(function () {
    ...
    var sibling = rowElm.nextSibling; // include heights of all nested rows, in parent rows
  ...
  return /*#__PURE__*/_react.default.createElement(Row, Object.assign({}, rest, {
    ref: inst
  }));
}
  ...
  (0, _react.useMemo)(function () {
    ...
    ctx_value._vtcomponents = {
      table: function table(props) {
        return /*#__PURE__*/_react.default.createElement(VTable2, Object.assign({}, props, {
          context: ctx,
          ref: ctx_value.ref
        }));
      },
      body: {
        wrapper: function wrapper(props) {
          return /*#__PURE__*/_react.default.createElement(ctx.Consumer, null, function
            /* value */
          () {
            return /*#__PURE__*/_react.default.createElement(VWrapper, Object.assign({}, props, {
              ctx: ctx_value
            }));
          });
        },
        row: function row(props) {
          return /*#__PURE__*/_react.default.createElement(VTRow, Object.assign({}, props, {
            context: ctx_value
          }));
        }
      }
